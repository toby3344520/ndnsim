...
namespace ns3 {
NS_LOG_COMPONENT_DEFINE("ndn-multimedia-simple-svc-example-tracers");
int
main(int argc, char* argv[])
{
 ...
 // Config::SetDefault("ns3::DropTailQueue::MaxPackets", StringValue("20"));
  ...
  producerHelper.SetAttribute("ContentDirectory", StringValue("/home/sun-linux/multimediaData"));
