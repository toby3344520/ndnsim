...
NS_LOG_COMPONENT_DEFINE("ndn-multimedia-simple-avc-example2-tracers");
int
main(int argc, char* argv[])
{
  ...
  mpdProducerHelper.SetAttribute("ContentDirectory", StringValue("/home/sun-linux/multimediaData"));
