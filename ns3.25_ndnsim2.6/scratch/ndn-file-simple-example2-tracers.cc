...
NS_LOG_COMPONENT_DEFINE("ndn-file-simple2-tracers");
void
...
main(int argc, char* argv[])
{
	LogComponentEnable("ndn.FileConsumer",LOG_LEVEL_FUNCTION);
		LogComponentEnable("ndn.FileConsumerCbr",LOG_LEVEL_FUNCTION);
 ...
 // Config::SetDefault("ns3::DropTailQueue::MaxPackets", StringValue("20")); //sun 2018/11/17
  ...
  consumerHelper.SetAttribute("FileToRequest", StringValue("/prefix/file1.img"));
