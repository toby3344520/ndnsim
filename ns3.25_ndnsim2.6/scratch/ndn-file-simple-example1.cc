...
NS_LOG_COMPONENT_DEFINE("ndn-file-simple-example1");
int
main(int argc, char* argv[])
{
	LogComponentEnable("ndn.Consumer",LOG_LEVEL_FUNCTION);
	LogComponentEnable("ndn.FileConsumer",LOG_LEVEL_FUNCTION);
	LogComponentEnable("ndn.FileServer",LOG_LEVEL_FUNCTION);
  // setting default parameters for PointToPoint links and channels
  Config::SetDefault("ns3::PointToPointNetDevice::DataRate", StringValue("1Mbps"));
  Config::SetDefault("ns3::PointToPointChannel::Delay", StringValue("10ms"));
 // Config::SetDefault("ns3::DropTailQueue::MaxPackets", StringValue("20")); //sun 2018/11/17
  ...
  consumerHelper.SetAttribute("FileToRequest", StringValue("/myprefix/red-rose.mp3"));// name of the file to request
